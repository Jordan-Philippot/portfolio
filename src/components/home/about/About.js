    ...
    <section id="about" className="container-fluid" ref={AboutComponentRef}>
      ...
      <div className="container-about">
        <p id="about-presentation" ref={smokyPresentationRef}>
          {/* Avec plus de 3 ans d'expérience dans le développement web, j’ai
          participé activement à la création de back-offices, e-commerce, SaaS,
          sites vitrines et autres solutions sur mesure. <br />
          Mon expertise sur <b>React/Typescript</b> et <b>Symfony</b> me permet
          de réaliser des projets innovants dans divers domaines, en apportant
          toujours un soin particulier aux besoins de l’utilisateur et au
          design.
          <br />
          Ces expériences m’ont également permis de maîtriser une approche
          polyvalente dans la résolution de problèmes et la conception de
          solutions efficaces, le tout avec une approche agile. */}
